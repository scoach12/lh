...
- ✅ **301-Redirect** bei GoDaddy aktiv (alte Domain → neue Domain)
- ✅ **Funnel-Grundgerüst:**
  - `#gratis-heft`-Section auf `index.html`
  - Sanfte CTAs in Blog-Artikeln (Trauma, Paar, Sexual)
  - Platzhalter `MAILERLITE_LANDINGPAGE_URL` markiert die Stellen, die noch getauscht werden müssen
- ✅ **Datenschutz DSGVO-konform** inkl. MailerLite-Abschnitt 7b
- ✅ **`_admin/`-Ordner** angelegt mit:
  - `README.md`
  - `MAILERLITE-CHECKLISTE.md`
  - `EMAIL-VORLAGEN.md`
...
### P3 — MailerLite-Landingpage einrichten (Sabrinas Aufgabe, ~45–60 Min)
**Verantwortlich:** Sabrina
**Anleitung:** `_admin/MAILERLITE-CHECKLISTE.md`
**Blocker für:** Funnel geht live

Wenn die Landingpage-URL steht:
